...
description: "AST-based CLI tool that extracts exported function signatures from source code with bodies stripped. Save 60-70% tokens for AI coding agents like Cursor, Claude Code, and Windsurf. Supports 16 languages."
template: splash
head:
  - tag: meta
    attrs:
