...
MCP lets the AI agent call vfs tools directly without shell access. This works even in sandboxed environments where the agent can't run arbitrary binaries.
